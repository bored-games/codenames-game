...
var author$project$Main$Model = function (turn) {
...
var author$project$Main$init = author$project$Main$Model(false)(0)('debug')(false)(false)(true)(true)(1)(1)('1w6mvdnr6vj')(_List_Nil);
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$onClick(author$project$Main$ToggleQR)
					]),
				_List_fromArray(
					[
						A2(elm$html$Html$div, _List_Nil, _List_Nil)
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$class(''),
												elm$html$Html$Events$onClick(author$project$Main$ToggleSpies)
											]),
										_List_fromArray(
											[
												A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c00')
									]),
								_List_fromArray(
									[
										A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$Attributes$class('decor_line')
															]),
														_List_Nil)
													])),
												A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c01')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c02')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c03')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c04')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c05')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c06')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c07')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c08')
									]),
								_List_fromArray(
									[
										A2(
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class('card_border'),
										elm$html$Html$Attributes$id('c09')
									]),
								_List_fromArray(
									[
										A2(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																elm$html$Html$text('Proposition')
															]))
													]))
											]))
									])),
