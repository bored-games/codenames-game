...
var author$project$Main$Model = function (seed) {
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$Model(
			elm$random$Random$initialSeed(99999999))(false)(0)('debug')(false)(false)(true)(false)(true)(1)(1)('1w6mvdnr6vj')(author$project$Wordlist$wordlistAdvanced)(
			_List_fromArray(
				[
...
var author$project$Main$colorCards = F5(
	function (assassinID, redIDs, blueIDs, index, card) {
		if (assassinID.$ === 'Just') {
			var aid = assassinID.a;
			return _Utils_eq(index, aid) ? _Utils_update(
				card,
			...
			if (words.b) {
				...
				return A2(
					...
					_Utils_update(
						c,
						{word: w}),
					A2(author$project$Main$populateCards, cs, ws));
			} else {
				return A2(
					elm$core$List$cons,
					_Utils_update(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'NewGame':
				...
				var newIDs = _n3.a;
				var seed3 = _n3.b;
				var assassinID = A2(elm$core$Array$get, 0, newIDs);
				var blueIDs = A3(
				...
				var newShuffledCards = A2(
					...
					A3(
						author$project$Main$colorCards,
						assassinID,
						elm$core$Array$toList(redIDs),
						elm$core$Array$toList(blueIDs)),
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							debugString: elm$core$String$concat(newWords),
	...
	function (index, cards) {
		if (cards.b) {
			...
			return A2(
				...
				A2(author$project$Main$drawCard, index + 1, cs));
		} else {
			return _List_Nil;
		}
	});
