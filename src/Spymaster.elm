...
view model =
    div [ class "container" ]
        [ div [ class ("lightbox" ++ (if model.toggleLightbox then "" else " hidden")), onClick ToggleLightbox ] [ div [] [] ]
        , div [ class "debug" ] []
        , div
            [ class ("sidebar" ++ (if model.toggleSidebar then " hidden" else ""))]
              ...
              , ul []
                [ li [] [ a [ class "" ] [ span [ class "icon edit"] [], text "Edit custom wordlist (not implemented)"] ]
